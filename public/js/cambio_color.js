...
// Esta función toma el color de la base de datos y luego llama a otra función para directamente cambiarlo.
...
$(document).ready(function() {
  ...
  recibir_color(); // Esta función se encargará de obtener el color de la base de datos y luego cambiar el color
  cambiar_color();
