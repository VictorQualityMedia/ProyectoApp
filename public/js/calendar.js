//https://year-calendar.github.io/js-year-calendar/examples.html
(function (global, factory) {
  ...
  function (_exports) {
      ...
      _createClass(Calendar, [
          ...
          value: function _initializeOptions(opt) {
            ...
            this.options = {
              ...
              numberMonthsDisplayed:
                !isNaN(parseInt(opt.numberMonthsDisplayed)) &&
                opt.numberMonthsDisplayed > 0 &&
                opt.numberMonthsDisplayed <= 12
                  ? parseInt(opt.numberMonthsDisplayed)
                  : 12,
              minDate: opt.minDate instanceof Date ? opt.minDate : null,
              maxDate: opt.maxDate instanceof Date ? opt.maxDate : null,
              language:
                opt.language != null && Calendar.locales[opt.language] != null
                  ? opt.language
                  //esp  español
                  : "esp",
              allowOverlap: opt.allowOverlap != null ? opt.allowOverlap : true,
              displayWeekNumber:
                opt.displayWeekNumber != null ? opt.displayWeekNumber : false,
              displayDisabledDataSource:
                opt.displayDisabledDataSource != null
                  ? opt.displayDisabledDataSource
                  : false,
              displayHeader:
                opt.displayHeader != null ? opt.displayHeader : true,
              alwaysHalfDay:
                opt.alwaysHalfDay != null ? opt.alwaysHalfDay : false,
              enableRangeSelection:
                opt.enableRangeSelection != null
                  ? opt.enableRangeSelection
                  : false,
              disabledDays:
                opt.disabledDays instanceof Array ? opt.disabledDays : [],
              disabledWeekDays:
                opt.disabledWeekDays instanceof Array
                  ? opt.disabledWeekDays
                  : [],
              hiddenWeekDays:
                opt.hiddenWeekDays instanceof Array ? opt.hiddenWeekDays : [],
              roundRangeLimits:
                opt.roundRangeLimits != null ? opt.roundRangeLimits : false,
              dataSource:
                opt.dataSource instanceof Array ||
                typeof opt.dataSource === "function"
                  ? opt.dataSource
                  : [],
              style:
                ...
                opt.style == "custom"
                  ...
                  : "border",
              enableContextMenu:
                opt.enableContextMenu != null ? opt.enableContextMenu : false,
              contextMenuItems:
                opt.contextMenuItems instanceof Array
                  ? opt.contextMenuItems
                  : [],
              customDayRenderer:
                typeof opt.customDayRenderer === "function"
                  ? opt.customDayRenderer
                  : null,
              customDataSourceRenderer:
                typeof opt.customDataSourceRenderer === "function"
                  ? opt.customDataSourceRenderer
                  : null,
              weekStart: !isNaN(parseInt(opt.weekStart))
                ? parseInt(opt.weekStart)
                : null,
              loadingTemplate:
                typeof opt.loadingTemplate === "string" ||
                opt.loadingTemplate instanceof HTMLElement
                  ? opt.loadingTemplate
                  : null,
            };
          ...
          value: function _initializeDatasourceColors() {
            for (var i = 0; i < this._dataSource.length; i++) {
              if (this._dataSource[i].color == null) {
                this._dataSource[i].color =
                  Calendar.colors[this._dataSource[i].id];
              }
            }
          },
          /**
        ...
        },
        {
          ...
          value: function _renderHeader() {
            ...
            if (
              ...
              this.options.minDate >= period.startDate
            ) {
            ...
            if (this._isFullYearMode()) {
              ...
              yearDiv.textContent = ""
                .concat(period.startDate.getFullYear(), " - ")
                .concat(period.endDate.getFullYear());
            } else if (this.options.numberMonthsDisplayed > 1) {
              yearDiv.textContent = ""
                .concat(
                  Calendar.locales[this.options.language].months[
            ...
            if (
              this.options.maxDate != null &&
              this.options.maxDate <= period.endDate
            ) {
            ...
            for (var m = 0; m < this.options.numberMonthsDisplayed; m++) {
              ...
              if (this.options.displayWeekNumber) {
                ...
                weekNumberCell.textContent =
                  Calendar.locales[this.options.language].weekShort;
              ...
              do {
                ...
                headerCell.textContent =
                  Calendar.locales[this.options.language].daysMin[d];
              ...
              while (currentDate <= lastDate) {
                ...
                if (this.options.displayWeekNumber) {
                  ...
                  currentThursday.setDate(
                    currentThursday.getDate() - weekStart + 4
                  );
                  weekNumberCell.classList.add("week-number");
                  weekNumberCell.textContent =
                    this.getWeekNumber(currentThursday).toString();
            ...
            if (this._dataSource != null && this._dataSource.length > 0) {
              this.element
                ...
                .forEach(function (month) {
                  ...
                  if (
                    (_this.options.minDate == null ||
                      lastDate > _this.options.minDate) &&
                    (_this.options.maxDate == null ||
                      firstDate <= _this.options.maxDate)
                  ) {
                    var monthData = [];

                    for (var i = 0; i < _this._dataSource.length; i++) {
                      if (
                        !(_this._dataSource[i].startDate >= lastDate) ||
                        _this._dataSource[i].endDate < firstDate
                      ) {
                    ...
                    if (monthData.length > 0) {
                      month
                        ...
                        .forEach(function (day) {
                          ...
                          if (
                            (_this.options.minDate == null ||
                              currentDate >= _this.options.minDate) &&
                            (_this.options.maxDate == null ||
                              currentDate <= _this.options.maxDate)
                          ) {
                            for (var i = 0; i < monthData.length; i++) {
                              if (
                                monthData[i].startDate < nextDate &&
                                monthData[i].endDate >= currentDate
                              ) {
                            ...
                            if (
                              dayData.length > 0 &&
                              (_this.options.displayDisabledDataSource ||
                                !_this._isDisabled(currentDate))
                            ) {
                              _this._renderDataSourceDay(
                                day,
                                currentDate,
                                dayData
                              );
          ...
          value: function _renderDataSourceDay(elt, currentDate, events) {
            ...
            switch (this.options.style) {
              ...
              case "background":
                ...
                if (
                  events[events.length - 1].startDate.getTime() == currentTime
                ) {
                  parent.classList.add("day-start");

                  if (
                    events[events.length - 1].startHalfDay ||
                    ...
                    for (var i = events.length - 2; i >= 0; i--) {
                      if (
                        events[i].startDate.getTime() != currentTime ||
                        (!events[i].startHalfDay && !this.options.alwaysHalfDay)
                      ) {
                    ...
                    parent.style.background = "linear-gradient(-45deg, "
                      .concat(events[events.length - 1].color, ", ")
                      .concat(events[events.length - 1].color, " 49%, ")
                      .concat(otherColor, " 51%, ")
                      .concat(otherColor, ")");
                  } else if (this.options.roundRangeLimits) {
                    parent.classList.add("round-left");
                  }
                } else if (
                  events[events.length - 1].endDate.getTime() == currentTime
                ) {
                  parent.classList.add("day-end");

                  if (
                    events[events.length - 1].endHalfDay ||
                    this.options.alwaysHalfDay
                  ) {
                    parent.classList.add("day-half"); // Find color for other half
                    ...
                    for (var i = events.length - 2; i >= 0; i--) {
                      if (
                        events[i].endDate.getTime() != currentTime ||
                        (!events[i].endHalfDay && !this.options.alwaysHalfDay)
                      ) {
                        otherColor = events[i].color;
                        break;
                      }
              ...
              case "custom":
                if (this.options.customDataSourceRenderer) {
                  this.options.customDataSourceRenderer.call(
                    this,
                    elt,
                    currentDate,
                    events
        ...
        },
        {
          ...
          value: function _applyEvents() {
            ...
            if (this.options.displayHeader) {
              ...
              this.element
                ...
                .addEventListener("click", function (e) {
                  if (!e.currentTarget.classList.contains("disabled")) {
                    var months =
                      _this2.element.querySelector(".months-container");
                    ...
                    setTimeout(function () {
                      ...
                      setTimeout(function () {
                        _this2.setStartDate(
                          new Date(
                            _this2._startDate.getFullYear(),
                            _this2._startDate.getMonth() -
                              _this2.options.numberMonthsDisplayed,
                            1
                          )
                        );
                      }, 50);
            ...
            var cells = this.element.querySelectorAll(
              ...
              if (_this2.options.enableRangeSelection) {
                cell.addEventListener("mousedown", function (e) {
                  if (e.which == 1) {
                    ...
                    if (
                      _this2.options.allowOverlap ||
                      _this2.isThereFreeSlot(currentDate)
                    ) {
            ...
            if (this.options.enableRangeSelection) {
              ...
              window.addEventListener("mouseup", function (e) {
                if (_this2._mouseDown) {
                  ...
                  var minDate =
                    _this2._rangeStart < _this2._rangeEnd
                      ? _this2._rangeStart
                      : _this2._rangeEnd;
                  var maxDate =
                    _this2._rangeEnd > _this2._rangeStart
                      ? _this2._rangeEnd
                      : _this2._rangeStart;
                  ...
                  _this2._triggerEvent("selectRange", {
                    startDate: minDate,
                    endDate: maxDate,
                    events: _this2.getEventsOnRange(
                      minDate,
                      new Date(
                        maxDate.getFullYear(),
                        maxDate.getMonth(),
            ...
            this._responsiveInterval = setInterval(function () {
              ...
              var monthSize =
                _this2.element.querySelector(".month").offsetWidth + 10;
              _this2._nbCols = null;

              if (
                monthSize * 6 < calendarSize &&
                _this2.options.numberMonthsDisplayed >= 6
              ) {
                _this2._nbCols = 2;
              } else if (
                monthSize * 4 < calendarSize &&
                _this2.options.numberMonthsDisplayed >= 4
              ) {
                _this2._nbCols = 3;
              } else if (
                monthSize * 3 < calendarSize &&
                _this2.options.numberMonthsDisplayed >= 3
              ) {
                _this2._nbCols = 4;
              } else if (
                monthSize * 2 < calendarSize &&
                _this2.options.numberMonthsDisplayed >= 2
              ) {
                _this2._nbCols = 6;
              } else {
                _this2._nbCols = 12;
              ...
              _this2.element
                ...
                .forEach(function (month) {
                  if (
                    !month.classList.contains("month-".concat(_this2._nbCols))
                  ) {
                    [
                      "month-2",
                      "month-3",
              ...
              this.element
                ...
                .forEach(function (month) {
                  ...
                  var monthStartDate = new Date(
                    _this3._startDate.getFullYear(),
                    _this3._startDate.getMonth() + monthId,
                    1
                  );
                  var monthEndDate = new Date(
                    _this3._startDate.getFullYear(),
                    _this3._startDate.getMonth() + monthId + 1,
                    1
                  );

                  if (
                    minDate.getTime() < monthEndDate.getTime() &&
                    maxDate.getTime() >= monthStartDate.getTime()
                  ) {
                    month
        ...
        },
        {
          ...
          value: function _openContextMenu(elt) {
            ...
            for (var i = 0; i < events.length; i++) {
              ...
              eventItem.style.boxShadow = "inset 4px 0 0 0 ".concat(
                events[i].color
              );
            ...
            if (contextMenu.children.length > 0) {
              ...
              if (
                contextMenu.getBoundingClientRect().right >
          ...
          value: function _renderContextMenuItems(parent, items, evt) {
            ...
            for (var i = 0; i < items.length; i++) {
              if (
                ...
                (typeof items[i].visible === "function" &&
                  !items[i].visible(evt))
              ) {
                continue;
              }
        ...
        },
        {
          ...
          value: function _checkContextMenuItemsPosition() {
            ...
            menus.forEach(function (menu) {
              ...
              if (
                htmlMenu.getBoundingClientRect().right >
                document.body.offsetWidth
              ) {
        ...
        },
        {
          ...
          value: function _getDate(elt) {
            ...
            var monthId = parseInt(
              elt.closest(".month-container").dataset.monthId
            );
            return new Date(
              this._startDate.getFullYear(),
              this._startDate.getMonth() + monthId,
              day
            );
          },
        },
        ...
        },
        {
          ...
          value: function _isDisabled(date) {
            if (
              (this.options.minDate != null && date < this.options.minDate) ||
              (this.options.maxDate != null && date > this.options.maxDate)
            ) {
              return true;
            }
        ...
        },
        {
          ...
          value: function _isFullYearMode() {
            return (
              this._startDate.getMonth() == 0 &&
              this.options.numberMonthsDisplayed == 12
            );
          },
          /**
        ...
        },
        {
          ...
          value: function getWeekNumber(date) {
            ...
            workingDate.setDate(
              workingDate.getDate() + 3 - ((workingDate.getDay() + 6) % 7)
            ...
            return (
              1 +
              Math.round(
                ((workingDate.getTime() - week1.getTime()) / 86400000 -
                  3 +
                  ((week1.getDay() + 6) % 7)) /
                  7
              )
        ...
        },
        {
          ...
          value: function getEventsOnRange(startDate, endDate) {
            ...
            if (this._dataSource && startDate && endDate) {
              for (var i = 0; i < this._dataSource.length; i++) {
                if (
                  this._dataSource[i].startDate < endDate &&
                  this._dataSource[i].endDate >= startDate
                ) {
          ...
          value: function isThereFreeSlot(date) {
            ...
            if (after === true) {
              return !events.some(function (evt) {
                return (
                  (!_this5.options.alwaysHalfDay && !evt.endHalfDay) ||
                  evt.endDate > date
                );
              });
            } else if (after === false) {
              return !events.some(function (evt) {
                return (
                  (!_this5.options.alwaysHalfDay && !evt.startHalfDay) ||
                  evt.startDate < date
                );
              });
            } else {
              return (
                this.isThereFreeSlot(date, false) ||
                this.isThereFreeSlot(date, true)
              );
            }
          },
          /**
        ...
        },
        {
          ...
          value: function getCurrentPeriod() {
            ...
            endDate.setMonth(
              endDate.getMonth() + this.options.numberMonthsDisplayed
            );
          ...
          value: function setStartDate(startDate) {
            ...
            if (startDate instanceof Date) {
              ...
              if (typeof this.options.dataSource === "function") {
                ...
                if (
                  !periodEventResult.preventRendering &&
                  (!yearEventResult || !yearEventResult.preventRedering)
                ) {
                  this.render();
                }
              }
          ...
          value: function setStyle(style) {
            var preventRendering =
              arguments.length > 1 && arguments[1] !== undefined
                ...
                : false;
            this.options.style =
              style == "background" || style == "border" || style == "custom"
                ? style
                : "border";
        ...
        },
        {
          ...
          value: function setDisplayDisabledDataSource(
            displayDisabledDataSource
          ) {
            var preventRendering =
              arguments.length > 1 && arguments[1] !== undefined
        ...
        },
        {
          ...
          value: function setDisabledDays(disabledDays) {
            ...
            this.options.disabledDays =
              disabledDays instanceof Array ? disabledDays : [];
        ...
        },
        {
          ...
          value: function setDisabledWeekDays(disabledWeekDays) {
            ...
            this.options.disabledWeekDays =
              disabledWeekDays instanceof Array ? disabledWeekDays : [];
          ...
          value: function setHiddenWeekDays(hiddenWeekDays) {
            var preventRendering =
              arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
                : false;
            this.options.hiddenWeekDays =
              hiddenWeekDays instanceof Array ? hiddenWeekDays : [];
          ...
          value: function setContextMenuItems(contextMenuItems) {
            var preventRendering =
              arguments.length > 1 && arguments[1] !== undefined
                ...
                : false;
            this.options.contextMenuItems =
              contextMenuItems instanceof Array ? contextMenuItems : [];
        ...
        },
        {
          ...
          value: function setCustomDayRenderer(customDayRenderer) {
            ...
            this.options.customDayRenderer =
              typeof customDayRenderer === "function"
                ? customDayRenderer
                : null;
        ...
        },
        {
          ...
          value: function setCustomDataSourceRenderer(
            customDataSourceRenderer
          ) {
            var preventRendering =
              arguments.length > 1 && arguments[1] !== undefined
            ...
            this.options.customDataSourceRenderer =
              typeof customDataSourceRenderer === "function"
                ? customDataSourceRenderer
                : null;
        ...
        },
        {
          ...
          value: function setDataSource(dataSource) {
            ...
            this.options.dataSource =
              dataSource instanceof Array || typeof dataSource === "function"
                ? dataSource
                : [];
        ...
        },
        {
          ...
          value: function getWeekStart() {
            return this.options.weekStart !== null
              ? this.options.weekStart
              : Calendar.locales[this.options.language].weekStart;
          },
          /**
          ...
          value: function setWeekStart(weekStart) {
            var preventRendering =
              arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
                : false;
            this.options.weekStart = !isNaN(parseInt(weekStart))
              ? parseInt(weekStart)
              : null;
        ...
        },
        {
          ...
          value: function setLoadingTemplate(loadingTemplate) {
            this.options.loadingTemplate =
              typeof loadingTemplate === "string" ||
              loadingTemplate instanceof HTMLElement
                ? loadingTemplate
                : null;
          },
          /**
    ...
    _defineProperty(Calendar, "colors", ["#0697f1", "#ef3107", "#eeb104"]);
